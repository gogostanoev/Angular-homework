...
// The application should contain a navigation bar that will enable the user to navigate between different parts of the application. The navigation should contain the following links:

// Home
// Products
// My Orders
// About
// In the home page, display a welcome message for the user. In the about page display a general info about the application: what is it for and who is the creator. In the Products page display a list of all products. The best way is to display the products like product cards.
...
// If the stock property is 0, disable the "Order" button so that the user won't be able to click it. In the My Orders page, display a list (Name and Price) for all orders that have been ordered by the user.
